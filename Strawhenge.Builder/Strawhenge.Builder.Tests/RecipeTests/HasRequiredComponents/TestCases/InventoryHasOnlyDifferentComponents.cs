...
{
    public class InventoryHasOnlyDifferentComponents : BaseHasRequiredComponentsTest
    {
        public InventoryHasOnlyDifferentComponents(ITestOutputHelper testOutputLogger) : base(testOutputLogger)
        {
        }
