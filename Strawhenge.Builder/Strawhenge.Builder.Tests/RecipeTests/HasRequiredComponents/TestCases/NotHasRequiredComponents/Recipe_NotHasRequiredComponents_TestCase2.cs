...
{
    public class Recipe_NotHasRequiredComponents_TestCase2 : BaseHasRequiredComponentsTest
    {
        public Recipe_NotHasRequiredComponents_TestCase2(ITestOutputHelper testOutputLogger) : base(testOutputLogger)
        {
        }
