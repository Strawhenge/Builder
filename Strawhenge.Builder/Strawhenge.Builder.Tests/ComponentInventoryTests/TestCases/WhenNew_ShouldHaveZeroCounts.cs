...
{
    public class WhenNew_ShouldHaveZeroCounts : BaseComponentInventoryTest
    {
        public WhenNew_ShouldHaveZeroCounts(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        }
