...
{
    public class WhenAddingSingleWood_ShouldIncrementWoodOnly : BaseComponentInventoryTest
    {
        public WhenAddingSingleWood_ShouldIncrementWoodOnly(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        }
