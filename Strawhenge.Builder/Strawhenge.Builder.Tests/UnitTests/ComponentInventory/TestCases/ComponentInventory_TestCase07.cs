...
{
    public class ComponentInventory_TestCase07 : ComponentInventory_Tests
    {
        public ComponentInventory_TestCase07(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        }
