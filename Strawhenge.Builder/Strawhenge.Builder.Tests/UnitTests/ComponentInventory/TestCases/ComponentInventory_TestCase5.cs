...
{
    public class ComponentInventory_TestCase5 : ComponentInventory_Tests
    {
        public ComponentInventory_TestCase5(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        }
