...
{
    public class ComponentInventory_TestCase6 : ComponentInventory_Tests
    {
        public ComponentInventory_TestCase6(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        }
