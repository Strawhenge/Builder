...
{
    public class ComponentInventory_TestCase8 : ComponentInventory_Tests
    {
        public ComponentInventory_TestCase8(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        }
